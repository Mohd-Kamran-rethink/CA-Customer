                    ...
                    <div class="row">
                        ...
                        <div class="col-6 d-flex mb-2">
                            <div class=" " style="width: -webkit-fill-available;" id="client-ajax-dropdown">
                                ...
                                <select {{!isset($transaction)?'':'disabled'}} onchange="renderClients()" name="client" id="selected-client"
                        ...
                        <div class="col-6 d-flex  mb-2">
                            <div style="width: -webkit-fill-available;" id="bank-account-append">
                                ...
                                <select  name="client_bank_account" class="form-control">
                                    <option value="">--Choose--</option>
                                    @if(isset($transaction))
                                        @foreach ($banks as $item)
                                        <option {{$item->id==$transaction->customer_bank_id?'selected':''}} value='{{$item->id }}'>{{$item->holder_name}}  -( {{ $item->account_number}} )</option>
                                        @endforeach
                                    @endif
                                </select>
                        ...
                        <input {{ session('user')->role === 'withdrawrer' ? 'readonly' : '' }} type="hidden"
