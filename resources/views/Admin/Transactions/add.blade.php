...
@section('content')
    ...
    <section class="content">
        <div class="card">
                                ...
                                <select name="bank_account" class="form-control searchOptions" tabindex="1">
                                    ...
                                    @foreach ($banks as $item)
                                        <option
                                            ...
                                            value="{{ $item->id }}">{{ $item->holder_name }} - {{ $item->bank_name }} -
                                            {{ $item->account_number }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input tabindex="2" type="text" name="utr"
            ...
            <input type="hidden" name="total" value="{{ isset($transaction) ? $transaction->total : old('total') }}"
