        ...
        <div class="card">
            <div class="card-body">
                <div class="mb-3 d-flex justify-content-between align-items-centers">
                    ...
                    <div>
                        <a href="{{ url($route.'/add') }}" class="btn btn-primary">Add {{$heading}}</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if (session('user')->phone !== $item->phone)
                                                        <a href="{{ url($route.'/edit/?id=' . $item->id) }}"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ url('/user/delete') }}" method="POST">
                    ...
                    <input type="hidden" name="role" id="deleteInput" value={{$role}}>
                    <div class="modal-body">
                        <h4>Are you sure you want to delete this {{$heading}}?</h4>
                    </div>
