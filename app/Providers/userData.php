...
class userData extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        View::composer('Admin.index', function ($view) {
            ...
            $approvedWithdraw = Transaction::where('type', 'Withdraw')->where('status', 'Approve')->get()->count();
            $approvedDeposit = Transaction::where('type', 'Deposit')->where('status', 'Approve')->get()->count();
            $franchiese = Franchise::get()->count();
            ...
            $view->with([
                ...
                'approvedWithdraw' => $approvedWithdraw,
                'approvedDeposit' => $approvedDeposit,
